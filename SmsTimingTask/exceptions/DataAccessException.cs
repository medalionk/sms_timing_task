...
{
    /// <summary>
    /// This exception is thrown if there is database access error.
    ...
    [Serializable]
    public class DataAccessException : SmsTimingException
    {
        /// <summary>
        ...
        ///<summary>
        /// Initializes a new instance of the <see cref = "DataAccessException" /> 
